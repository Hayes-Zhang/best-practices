...
三种产出质量，**必须诚实标注**：
- ✅ **成熟实践**：多个权威来源一致推荐，可放心采用
- 🔧 **综合实践**：从碎片来源拼出来的，方向可靠但细节需调整
- 💡 **原创实践**：基于搜索结果和第一性原理推导，未经大规模验证
...
1. **来源整合**：合并 scout 找到的所有来源，去重
2. **质量排序**：按 analyst 的评估结果排序
3. **分层归类**：
   - ✅ **成熟实践**：scout 找到 + analyst 高分确认
   - 🔧 **综合实践**：analyst 从多个碎片来源综合的建议
   - 💡 **原创实践**：creator 基于第一性原理推导
